...
HRESULT SetAVMEncoderSetting(IKsPropertySet *propertySet, ULONG setting, ULONG param1, ULONG param2)
{
	...
	return propertySet->Set(AVER_HW_ENCODE_PROPERTY, PROPERTY_HW_ENCODE_PARAMETER, &params, sizeof(params), &params, sizeof(params));
}
...
bool HVideoEncoder::Encode(unsigned char *data[DSHOW_MAX_PLANES], size_t linesize[DSHOW_MAX_PLANES], long long timestampStart, long long timestampEnd, EncoderPacket &packet,
			   bool &new_packet)
{
	new_packet = false;
