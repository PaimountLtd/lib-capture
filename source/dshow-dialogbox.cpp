...
namespace DShow {
DeviceDialogBox::DeviceDialogBox() : threadId(0), threadHandle(nullptr), isOpen(false) {}
...
DWORD DeviceDialogBox::Create()
{
	...
	if (pages != nullptr) {
		if (SUCCEEDED(pages->GetPages(&cauuid)) && cauuid.cElems) {
			...
			OleCreatePropertyFrame(nullptr, 0, 0, nullptr, 1, objects, cauuid.cElems, cauuid.pElems, 0, 0, nullptr);
